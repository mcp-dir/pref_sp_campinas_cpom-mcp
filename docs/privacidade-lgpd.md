...
Prefeitura SP Campinas: CPOM segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [pref_sp_campinas_cpom@mcp.ai](mailto:pref_sp_campinas_cpom@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
